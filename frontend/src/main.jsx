...
// Static data matching seed.py defaults — no backend required
const DASH = {
  ...
  byEquipment: [
    {equipment:"MRI 3T A", modality:"MRI", period:"2026-01", kwh:10567, kgco2e:1056.7, scans:1200, energyPerScan:8.806, idleWasteKwh:1800, confidence:"estimated"},
    {equipment:"CT Scanner A", modality:"CT", period:"2026-01", kwh:12756.8, kgco2e:1275.68, scans:1800, energyPerScan:7.087, idleWasteKwh:960, confidence:"estimated"},
    {equipment:"Digital X-ray Room", modality:"X-ray", period:"2026-01", kwh:2673.4, kgco2e:267.34, scans:2500, energyPerScan:1.069, idleWasteKwh:240, confidence:"estimated"},
    {equipment:"Ultrasound Fleet", modality:"Ultrasound", period:"2026-01", kwh:385.68, kgco2e:38.57, scans:2500, energyPerScan:0.154, idleWasteKwh:48, confidence:"estimated"},
    {equipment:"PACS Storage", modality:"PACS/RIS", period:"2026-01", kwh:2976, kgco2e:297.6, scans:2500, energyPerScan:1.190, idleWasteKwh:480, confidence:"estimated"},
    {equipment:"Reporting Workstations", modality:"Workstation", period:"2026-01", kwh:611.7, kgco2e:61.17, scans:2500, energyPerScan:0.245, idleWasteKwh:96, confidence:"estimated"},
  ],
  assumptions: ["All defaults are editable", "Values are labelled as measured, estimated, or assumed", "Use local metering data for formal reporting"],
};
DASH.topOpportunities = [...DASH.byEquipment].sort((a, b) => b.idleWasteKwh - a.idleWasteKwh).slice(0, 5);

const AI = {
  workloads: [{
    name: "Chest CT triage AI", useCase: "Triage", deployment: "Cloud",
    trainingKwh: 0, inferenceKwh: 0.12, grossKgCo2e: 0.012,
    savingsKgCo2e: 12, netKgCo2e: -11.988, confidence: "estimated",
    whatThisMeans: "Net impact compares AI compute footprint with operational savings from fewer repeats, shorter scans, or reduced travel.",
  }],
};
    ...
    <>
      ...
      {page === 'scenario' && (
        <main>
          ...
          <div className="grid">
            ...
            <label>Cloud provider<select><option>Local compute</option><option>AWS</option><option>Azure</option><option>Google Cloud</option></select></label>
      ...
      {page === 'export' && (
        <main>
          ...
          <button className="download" onClick={downloadCSV}><Download/>Download CSV</button>
